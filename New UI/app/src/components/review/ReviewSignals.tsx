    ...
    <div className="space-y-4">
      ...
      <div className="bg-[#252525] rounded-xl p-4 border border-white/5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-medium text-white">Proposal Status</h4>
        </div>
      ...
      <div className="bg-[#252525] rounded-xl p-4 border border-white/5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-medium text-white">Gap Fill Summary</h4>
        </div>
      ...
      {reviewSignals.categoryEClarification.count > 0 && (
        <div className="bg-[#252525] rounded-xl p-4 border border-white/5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-medium text-white">Category E Clarification</h4>
          </div>
      ...
      {reviewSignals.invalidPatternIds.length > 0 && (
        <div className="bg-[#252525] rounded-xl p-4 border border-red-500/20">
          <div className="flex items-center gap-2 mb-3">
            <FileWarning className="h-4 w-4 text-[#ef4444]" />
            <h4 className="text-sm font-medium text-white">Invalid Pattern IDs</h4>
          </div>
          <div className="flex flex-wrap gap-2">
            {reviewSignals.invalidPatternIds.map((id) => (
              <span
                key={id}
                className="px-2 py-1 rounded-md bg-red-500/10 text-red-400 text-xs font-mono"
              >
                {id}
              </span>
            ))}
      ...
      <div className="bg-[#252525] rounded-xl p-4 border border-white/5">
        <div className="flex items-center gap-2 mb-3">
          ...
          />
          <h4 className="text-sm font-medium text-white">Readiness</h4>
        </div>
