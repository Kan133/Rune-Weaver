  ...
  return [
    {
      ...
      content: [
        ...
        "If the target file is a TypeScript generator template, edit the generator source, not imagined emitted output.",
        "When replacing code inside a template-literal builder, preserve the surrounding '? ` ... ` : \"\"' structure unless the target range explicitly includes it.",
        "Escape literal backticks inside replacement text as \\` so the edited TypeScript file remains syntactically valid.",
      ].join("\n"),
    },
    {
      role: "user" as const,
      content: [
        ...
        context.instruction,
        "",
        "Important editing context:",
        "- This file is a generator source template, not generated runtime output.",
        "- Preserve any surrounding template literal wrappers and generator branching syntax.",
        "- If your replacement includes Rune Weaver log strings, escape literal backticks as \\`.",
        "",
