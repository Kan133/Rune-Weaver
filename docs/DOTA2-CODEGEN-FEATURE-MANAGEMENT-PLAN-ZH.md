...
> Status Note
> 本文档是 Dota2 主线规划稿，可用于理解方向，但不应覆盖当前 README-target MVP 的执行基线。
> 当前 agent 执行顺序与交付边界，应以 [AGENT-EXECUTION-BASELINE.md](D:\Rune Weaver\docs\AGENT-EXECUTION-BASELINE.md)、[HANDOFF.md](D:\Rune Weaver\docs\HANDOFF.md) 与 [ROADMAP.md](D:\Rune Weaver\docs\ROADMAP.md) 为准。
> 若本文与当前范围冲突，应优先保证 host separation、feature create/update/delete、minimum governance 这条主线闭环。
