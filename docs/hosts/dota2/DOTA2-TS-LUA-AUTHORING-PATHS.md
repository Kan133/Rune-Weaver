...
> Read when: understanding Dota2 TS/Lua authoring-path boundaries or generator-family tradeoffs
> Do not use for: delivery status, cross-host runtime language rules, or current milestone sequencing
