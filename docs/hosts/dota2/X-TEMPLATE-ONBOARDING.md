...
> Read when: onboarding a Dota2 x-template workspace or checking x-template setup expectations
> Do not use for: current lifecycle authority, independent GUI execution semantics, or cross-host onboarding rules
