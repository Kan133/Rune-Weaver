...
> Read when: integrating Rune Weaver with the Dota2 x-template host or checking Dota2-specific host assumptions
> Do not use for: current milestone priority, cross-host architecture truth, or universal host rules
