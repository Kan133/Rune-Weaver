...
> Read when: planning future Dota2 CLI refactors
> Do not use for: current CLI authority, current execution order, or justification to rewrite working CLI behavior
