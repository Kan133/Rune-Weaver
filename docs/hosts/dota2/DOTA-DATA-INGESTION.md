...
> Read when: updating Dota2 reference-data ingestion or understanding Dota2 knowledge-source layout
> Do not use for: current execution queue, generator authority, or cross-host data policy
