...
> Read when: changing Dota2 KV generator scope or deciding whether Dota2 output belongs in KV
> Do not use for: Dota2 lifecycle status, cross-host generator policy, or current acceptance by itself
