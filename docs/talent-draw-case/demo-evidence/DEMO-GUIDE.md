...
**Generated:** 2026-04-14T10:59:43.304Z  
**Status:** PASS  
**Host:** D:\RN  
**Mode:** write  
...
```bash
npm run demo:talent-draw -- --host D:\RN
```
...
1. Open Dota 2 Workshop Tools for the addon at `D:\RN`.
...
| WritePlan | 8 entries, target=D:\RN |
| Generated | 8 files |
| Smoke | 23/23 passed |
...
| --- | --- | --- |
| input.key_binding | input | preferred |
| data.weighted_pool | data | preferred |
| rule.selection_flow | rule | preferred |
| ui.selection_modal | ui | preferred |
...
| --- | --- | --- |
| game/scripts/src/rune_weaver/generated/server/talent_draw_demo_input_input_key_binding_ability.ts | yes | /**  * TalentDrawDemoInputInputKeyBindingAbility  * 按键绑定模块 - Generated by Rune W |
| game/scripts/src/rune_weaver/generated/server/talent_draw_demo_input_input_key_binding.ts | yes | /**  * TalentDrawDemoInputInputKeyBinding  * 按键绑定模块 - Generated by Rune Weaver   |
| game/scripts/src/rune_weaver/generated/shared/talent_draw_demo_data_data_weighted_pool.ts | yes | /**  * TalentDrawDemoDataDataWeightedPool  * 加权随机池 - Generated by Rune Weaver  * |
| game/scripts/src/rune_weaver/generated/server/talent_draw_demo_rule_rule_selection_flow.ts | yes | /**  * TalentDrawDemoRuleRuleSelectionFlow  * 选择流程管理器 - Generated by Rune Weaver |
| content/panorama/src/rune_weaver/generated/ui/talent_draw_demo_ui_ui_selection_modal.tsx | yes | /**  * TalentDrawDemoUiUiSelectionModal  * Generated selection modal  *  * Featu |
| content/panorama/src/rune_weaver/generated/ui/talent_draw_demo_ui_ui_selection_modal.less | yes | /* Generated by Rune Weaver */ /* talent_draw_demo - ui.selection_modal */  .tal |
...
| game/scripts/npc/npc_abilities_custom.txt | yes | "rw_talent_draw_demo_modifier_applier" {     "BaseClass"              "ability_d |
